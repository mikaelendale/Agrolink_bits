                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 align-self-center col-lg-3 col-3">
                                    <div class="text-end text-sm-start text-xl-end text-nowrap">
                                        <a href="withdrow.html" class="btn btn-primary">Withdraw <svg class="ms-2"
                                                width="10" height="18" viewBox="0 0 11 18" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                    ...
                    <div class="card">
                        <div class="card-body pb-0">
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                <span><svg class="me-2" width="16" height="16" viewBox="0 0 16 16"
                    ...
                    <div class="card bg-primary food-grap">
                        <div class="card-body pb-0">
                            <div class="data-info">
                                ...
                                <div
                                    class="data-content d-flex border-0 align-items-center justify-content-between pt-2">
