                            ...
                            <div class="card-body px-3">
                                ...
                                <div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <svg class="me-2" width="4" height="5" viewBox="0 0 4 5" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="order-menu">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="order-items">
                                            <h6 class="font-w500 text-nowrap mb-0"><a href="javascript:void(0);">Pepperoni
                                                    Pizza</a></h6>
                                            <p class="mb-0">x1</p>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="order-items">
                                            <h6 class="font-w500 text-nowrap mb-0"><a href="javascript:void(0);">Fish
                                                    Burger</a></h6>
                                            <p class="mb-0">x1</p>
                                        </div>
                                        <h6 class="text-primary mb-0 ms-auto">+$5.59</h6>
                                    ...
                                    <a href="javascript:void(0);"
                                        class="btn btn-outline-success bgl-success btn-block">Completed</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card h-auto b-hover">
                            <div class="card-body px-3">
                                ...
                                <div class="order-menu">
                                    <h6>Order Menu</h6>
                                    <div class="d-flex align-items-center mb-2">
                                        <img class="me-2" src="images/popular-img/review-img/pic-2.jpg" alt="">
                                        <div class="order-items">
                                            <h6 class="font-w500 text-nowrap mb-0"><a href="javascript:void(0);">Japan
                                                    Ramen</a></h6>
                                            <p class="mb-0">x1</p>
                                        </div>
                                        <h6 class="text-primary mb-0 ms-auto">+$5.59</h6>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <img class="me-2" src="images/popular-img/pic-2.jpg" alt="">
                                        <div class="order-items">
                                            <h6 class="font-w500 text-nowrap mb-0"><a href="javascript:void(0);">Beef
                                                    Burger</a></h6>
                                            <p class="mb-0">x1</p>
                                        </div>
                                        <h6 class="text-primary mb-0 ms-auto">+$5.59</h6>
                                    ...
                                    <a href="javascript:void(0);"
                                        class="btn btn-outline-primary bgl-primary btn-block">Delivering to you</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body px-3">
                                ...
                                <div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <p class="mb-0 px-2">5.0</p>
                                        <svg class="me-2" width="4" height="5" viewBox="0 0 4 5"
                                ...
                                <div class="order-menu">
                                    <h6>Order Menu</h6>
                                    <div class="d-flex align-items-center mb-2">
                                        <img class="me-2" src="images/popular-img/review-img/pic-3.jpg" alt="">
                                        <div class="order-items">
                                            <h6 class="font-w600 text-nowrap mb-0"><a href="javascript:void(0);">Fried
                                                    Rice</a></h6>
                                            <p class="mb-0">x1</p>
                                        </div>
                                        <h6 class="text-primary mb-0 ms-auto">+$5.59</h6>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <img class="me-2" src="images/popular-img/pic-3.jpg" alt="">
                                        <div class="order-items">
                                            <h6 class="font-w600 text-nowrap mb-0"><a href="javascript:void(0);">Cheese
                                                    Burger</a></h6>
                                            <p class="mb-0">x1</p>
                                        </div>
                                        <h6 class="text-primary mb-0 ms-auto">+$5.59</h6>
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-outline-info bgl-info btn-block ">Order
                                        being prepared</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card h-auto b-hover">
                            <div class="card-body px-3">
                                ...
                                <div class="order-menu">
                                    <h6>Order Menu</h6>
                                    <div class="d-flex align-items-center mb-2">
                                        <img class="me-2" src="images/popular-img/review-img/pic-4.jpg" alt="">
                                        <div class="order-items">
                                            <h6 class="font-w600 text-nowrap mb-0"><a href="javascript:void(0);">Vegan
                                                    Pizza</a></h6>
                                            <p class="mb-0">x1</p>
                                        </div>
                                        <h6 class="text-primary mb-0 ms-auto">+$5.59</h6>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <img class="me-2" src="images/popular-img/pic-4.jpg" alt="">
                                        <div class="order-items">
                                            <a href="javascript:void(0);">
                                                <h6 class="font-w600 text-nowrap mb-0">Double Burger</h6>
                                            </a>
                                            <p class="mb-0">x1</p>
                                        </div>
                                        <h6 class="text-primary mb-0 ms-auto">+$5.59</h6>
                            ...
                            <div class="card-body px-3">
                                ...
                                <div class="order-menu">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <img class="me-2" src="images/popular-img/review-img/pic-1.jpg" alt="">
                                        <div class="order-items">
                                            <h6 class="font-w600 text-nowrap mb-0"><a href="javascript:void(0);">Pepperoni
                                                    Pizza</a></h6>
                                            <p class="mb-0">x1</p>
                                        </div>
                                        <h6 class="text-primary mb-0 ms-auto">+$5.59</h6>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <img class="me-2" src="images/popular-img/pic-1.jpg" alt="">
                                        <div class="order-items">
                                            <h6 class="font-w600 text-nowrap mb-0"><a href="javascript:void(0);">Fish
                                                    Burger</a></h6>
                                            <p class="mb-0">x1</p>
                                        </div>
                                        <h6 class="text-primary mb-0 ms-auto">+$5.59</h6>
                            ...
                            <div class="card-body px-3">
                                ...
                                <div class="order-menu">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <img class="me-2" src="images/popular-img/review-img/pic-2.jpg" alt="">
                                        <div class="order-items">
                                            <h6 class="font-w600 text-nowrap mb-0"><a href="javascript:void(0);">Japan
                                                    Ramen</a></h6>
                                            <p class="mb-0">x1</p>
                                        </div>
                                        <h6 class="text-primary mb-0 ms-auto">+$5.59</h6>
                    ...
                    <div class="card-body px-3">
                        ...
                        <div class="order-menu style-3">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    <h4 class="font-w600 text-nowrap mb-0"><a href="javascript:void(0);">Pepperoni
                                            Pizza</a></h4>
                                    <p class="mb-0">x1</p>
                                </div>
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    <h4 class="font-w600 text-nowrap mb-0"><a href="javascript:void(0);">Japan Ramen</a>
                                    </h4>
                                    <p class="mb-0">x1</p>
                                </div>
                                <h4 class="text-primary mb-0 ms-auto">+$5.59</h4>
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <img class="me-3" src="images/popular-img/review-img/pic-4.jpg" alt="">
                                <div>
                                    <h4 class="font-w600 text-nowrap mb-0"><a href="javascript:void(0);">Japan Ramen</a>
                                    </h4>
                                    <p class="mb-0">x1</p>
                            ...
                            <div class="d-flex align-items-center mb-4">
                                <img class="me-3" src="images/popular-img/review-img/pic-3.jpg" alt="">
                                <div>
                                    <h4 class="font-w600 text-nowrap mb-0"><a href="javascript:void(0);">Fried Rice</a>
                                    </h4>
                                    <p class="mb-0">x1</p>
                                </div>
                                <h4 class="text-primary mb-0 ms-auto">+$5.59</h4>
                        ...
                        <a href="javascript:void(0);" class="btn btn-outline-primary bgl-primary btn-block">Delivering to
                            you</a>
                    </div>
                </div>
            </div>
