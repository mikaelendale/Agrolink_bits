                ...
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <div class="d-flex align-items-center justify-content-between mb-2 gap">
                            <h4 class="mb-0 cate-title">
                                Category
                            </h4>
                            <a href="favorite-menu.html" class="text-primary">View all
                                <i class="fa-solid fa-angle-right ms-2"></i></a>
                        </div>
                                            ...
                                            <div class="card-body">
                                                <svg width="50" height="50" viewBox="0 0 50 50" fill="none"
                                                    ...
                                                    <path
                                                        ...
                                                        fill="#3D4152" />
                                                    <path d="M11.1459 18.0729L13.75 38.8542H36.25L38.8542 18.0729H11.1459Z"
                                                        fill="#FC8019" />
                                                    <path
                                        ...
                                        <div class="card-footer border-0 px-3">
                                            ...
                                            <div class="common d-flex align-items-end justify-content-between">
                                                <div>
                                                    ...
                                                    <h3 class="font-w700 mb-0 text-primary">
                                                        $5.59
                                                    </h3>
                                                </div>
                                        ...
                                        <div class="card dishe-bx b-hover review style-1">
                                            ...
                                            <div class="card-footer pt-0 border-0 text-center">
                                                <div>
                                                    ...
                                                    <h3 class="font-w700 text-primary">
                                                        $5.59
                                                    </h3>
                    ...
                    <div class="col-xl-12">
                        <div class="card dlab-bg dlab-position">
                            ...
                            <div class="card-body pt-0 pb-2">
                                ...
                                <div class="bb-border">
                                    <p class="font-w500 text-primary fs-15 mb-2">
                                        Your Address
                                    </p>
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <h4 class="mb-0">
                                        ...
                                        <a href="javascript:void(0);"
                                            class="btn btn-outline-primary btn-sm change">Change</a>
                                    </div>
                                    <p>
                                ...
                                <div class="order-check d-flex align-items-center my-3">
                                    ...
                                    <div class="dlab-info">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h4 class="dlab-title">
                                                <a href="javascript:void(0);">Pepperoni
                                                    Pizza</a>
                                            </h4>
                                ...
                                <div class="order-check d-flex align-items-center my-3">
                                    ...
                                    <div class="dlab-info">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h4 class="dlab-title">
                                                <a href="javascript:void(0);">Japan Ramen</a>
                                            </h4>
                                            <h4 class="text-primary ms-2">
                                                +$5.59
                                            </h4>
                            ...
                            <div class="card-footer pt-0 border-0">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    ...
                                    <h3 class="font-w500 text-primary">
                                        $202.00
                                    </h3>
                                </div>
